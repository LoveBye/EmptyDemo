...
import kotlinx.android.synthetic.main.item_recycler_fenzu.*
        ...
        override fun convert(helper: BaseViewHolder, item: MySection) {
            ...
            helper.getView<TextView>(R.id.tv_name).setOnClickListener({
                ...
                when (data.indexOf(item)) {
                    0 -> {
                        mIntent.setClass(this@MainActivity, PullDownEnlargeActivity::class.java)
                        startActivity(mIntent)
                    }
                    1 -> {
                        mIntent.setClass(this@MainActivity, GroupTitleActivity::class.java)
                        startActivity(mIntent)
                    }
                    2 -> {
                        mIntent.setClass(this@MainActivity, WaterfallActivity::class.java)
                        startActivity(mIntent)
                    }

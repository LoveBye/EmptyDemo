...
//                    .asBitmap()//强制Glide返回一个Bitmap对象
            ...
            helper.getView<View>(R.id.item_parent).setOnClickListener {
                ...
                val intent = android.content.Intent(this@RetrofitActivity, com.example.myapplication.view.ImagePagerActivity::class.java)
                intent.putExtra(com.example.myapplication.view.ImagePagerActivity.EXTRA_IMAGE_INDEX, data.indexOf(item))
                intent.putExtra(com.example.myapplication.view.ImagePagerActivity.EXTRA_IMAGE_URLS, mListPics)

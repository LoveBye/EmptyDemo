package com.example.myapplication.rxjava.module.rxjava2.usecases.zip;

import android.annotation.SuppressLint;
import android.util.Log;

import com.example.myapplication.rxjava.model.CategoryResult;
import com.example.myapplication.rxjava.model.MobileAddress;
import com.example.myapplication.rxjava.module.rxjava2.operators.item.RxOperatorBaseActivity;
import com.example.myapplication.rxjava.net.Network;
...
public class RxCaseZipActivity extends RxOperatorBaseActivity {
    ...
    protected void doSomething() {
        Observable<MobileAddress> observable1 = Rx2AndroidNetworking
                .get("http://api.avatardata.cn/MobilePlace/LookUp?key=ec47b85086be4dc8b5d941f5abd37a4e&mobileNumber=13021671512")
                .build()
                .getObjectObservable(MobileAddress.class);

        Observable<CategoryResult> observable2 = Network
                .getGankApi()

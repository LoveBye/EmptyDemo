...
public class PreviewActivity extends Activity {
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
        ...
        intent.putExtra(AlbumConstants.MAX_SELECT_COUNT, maxSelectCount);
        intent.putExtra(AlbumConstants.IS_SINGLE, isSingle);
        intent.putExtra(AlbumConstants.POSITION, position);
        activity.startActivityForResult(intent, AlbumConstants.RESULT_CODE);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMaxCount = intent.getIntExtra(AlbumConstants.MAX_SELECT_COUNT, 0);
        isSingle = intent.getBooleanExtra(AlbumConstants.IS_SINGLE, false);
        ...
        vpImage.setCurrentItem(intent.getIntExtra(AlbumConstants.POSITION, 0));
    }
    ...
    public void finish() {
        ...
        intent.putExtra(AlbumConstants.IS_CONFIRM, isConfirm);
        setResult(AlbumConstants.RESULT_CODE, intent);
        super.finish();
    }
}

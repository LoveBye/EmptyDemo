...
public class ImageSelectorActivity extends Activity {
    ...
    public static void openActivity(Activity activity, int requestCode,
        ...
        intent.putStringArrayListExtra(AlbumConstants.SELECTED, selected);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSelectedImages = intent.getStringArrayListExtra(AlbumConstants.SELECTED);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == AlbumConstants.RESULT_CODE) {

            if (data != null && data.getBooleanExtra(AlbumConstants.IS_CONFIRM, false)) {

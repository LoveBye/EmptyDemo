...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
        ...
        if (camera != null) {
            try {
                ...
                if (mParameters != null) {
                    ...
                    if (StringUtils.INSTANCE.isNotEmpty(mode)) {
    ...
    public MediaObject setOutputDirectory(String key, String path) {
        if (StringUtils.INSTANCE.isNotEmpty(path)) {
    ...
    public void startPreview() {
        ...
        try {
            ...
            try {
                ...
                Log.e("Yixia", "setPreviewDisplay fail " + "" + e.toString());
            }
            ...
            Log.e("Yixia", "startPreview fail :" + "" + e.toString());
        }
    }

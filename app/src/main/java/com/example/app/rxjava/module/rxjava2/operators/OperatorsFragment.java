package com.example.app.rxjava.module.rxjava2.operators;

import android.content.Intent;

import com.example.app.R;
import com.example.app.rxjava.model.OperatorModel;
import com.example.app.rxjava.module.rxjava2.CategoryBaseFragment;
import com.example.app.rxjava.module.rxjava2.operators.item.RxAsyncSubjectActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxBehaviorSubjectActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxBufferActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxCompletableActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxConcatActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxConcatMapActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxCreateActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxDebounceActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxDeferActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxDistinctActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxDoOnNextActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxFilterActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxFlatMapActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxFlowableActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxIntervalActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxJustActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxLastActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxMapActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxMergeActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxPublishSubjectActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxReduceActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxScanActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxSingleActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxSkipActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxTakeActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxTimerActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxWindowActivity;
import com.example.app.rxjava.module.rxjava2.operators.item.RxZipActivity;
